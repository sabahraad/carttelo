...
@section('page_title', 'Manage Admin Users')

@section('content')
    <div class="flex justify-between items-center mb-6">
        <p class="text-gray-600">Create and manage admin users who can access the admin panel.</p>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-3">
                                ...
                                @if($admin->id !== auth()->id())
                                    <form action="{{ route('admin.admins.destroy', $admin) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this admin user?');">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start">
            ...
            <div>
                <h4 class="text-sm font-semibold text-blue-900">About Admin Users</h4>
                <p class="text-sm text-blue-700 mt-1">
                    Admin users have full access to the admin panel including products, orders, settings, and user management. 
