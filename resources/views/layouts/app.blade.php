        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <a href="{{ route('contact') }}" class="text-gray-600 hover:text-blue-600 transition">
                        Contact
                    </a>
            ...
            <div class="flex flex-col items-center gap-4">
                ...
                @if($fb || $ig || $em)
                    <div class="flex items-center gap-4">
                        @if($fb)
                            <a href="{{ $fb }}" target="_blank" rel="noopener" class="text-gray-400 hover:text-blue-400 transition" title="Facebook">
                        ...
                        @endif
                        @if($ig)
                            <a href="{{ $ig }}" target="_blank" rel="noopener" class="text-gray-400 hover:text-pink-400 transition" title="Instagram">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        @endif
                        @if($em)
                            <a href="mailto:{{ $em }}" class="text-gray-400 hover:text-green-400 transition" title="Email">
